...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = 'Acres2_df9d623d0821e1d37935_20220622155717_archive.zip';
	const ARCHIVE_SIZE		 = '590501096';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'df9d623-22155717';
    const SECONDARY_PACKAGE_HASH = 'bf16ceb-22155717';
	const VERSION			 = '1.4.6';
